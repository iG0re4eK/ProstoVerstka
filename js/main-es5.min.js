!(function () {
  ...
  (function () {
    let e = document.querySelector(".burger"),
      ...
      l = document.querySelector(".header__nav-close"),
    ...
    if (
      ...
      for (let c = 0; c < r.length; c += 1)
        r[c].addEventListener("click", () => {
          t.classList.remove("header__nav_active");
        });
  })(),
  (function () {
    let e = function (e, t) {
      let l = document.querySelector(".header").clientHeight,
        r = document.querySelector(e).getBoundingClientRect().top - l,
